...
class RestoreCommand extends BaseCommand 
{
	...
	{		
		...
		if ( $this->option('nome') )
		{
                    $fileName = $this->input->getOption('nome');
	...
	protected function restoreDump($fileName)
	{
		...
		{
			return $this->line(
				sprintf('%s Restaurado com Sucesso.', $fileName)
			);
		}
	...
	protected function getOptions()
	{
		return [
			...
			['nome', null, InputOption::VALUE_OPTIONAL, 'Especifica o nome do backup para restaurar'],
		];
	}
