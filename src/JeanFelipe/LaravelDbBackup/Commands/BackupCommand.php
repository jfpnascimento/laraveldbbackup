...
namespace JeanFelipe\LaravelDbBackup\Commands;
...
use JeanFelipe\LaravelDbBackup\Commands\Helpers\BackupFile;
use JeanFelipe\LaravelDbBackup\Commands\Helpers\BackupHandler;
...
class BackupCommand extends BaseCommand 
{
	...
	public function fire()
	{
		...
		//----------------
		$dbfile = new BackupFile( $this->input->getOption('nome'), $database, $this->getDumpsPath() );
		...
		$this->line( $handler->Resposta( $this->argument('filename'), $this->filePath, $this->fileName ) );
	...
	{
		return [
			['nome', null, InputOption::VALUE_OPTIONAL, 'Nome do Arquivo de Backup'],
