<?php namespace JeanFelipe\LaravelDbBackup\Commands\Helpers;
...
use JeanFelipe\LaravelDbBackup\ConsoleColors;
...
class BackupHandler {
	...
	public function dumpResponse( $filenameArg, $filePath, $fileName )
	{
        ...
        public function Resposta( $filenameArg, $filePath, $fileName )
	{
		$message = 'Backup do Banco de Dados criado com sucesso, salvo no disco \'Dumps\' com o nome '.$fileName;
		$param = $fileName;
